...
Dash UI component suite for materialsintelligence project
...
5. Find source files
  ...
  - Navigate to `webpack:// -> [your/repo/path]] -> dash-materialsintelligence -> src` to find your component source files.
...
3. Run the dash layout you want to test
        ...
        # Import dash-materialsintelligence to your layout, then run it:
